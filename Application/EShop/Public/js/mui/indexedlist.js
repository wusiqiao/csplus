...
(function($, window, document) {
	...
	var IndexedList = $.IndexedList = $.Class.extend({
		...
		findElements: function() {
			...
			self.el.searcharea = self.box.querySelector(classSelector('search-area'));
		...
		caleLayout: function() {
			var self = this;
			var withoutSearchHeight = (document.body.offsetHeight - self.el.mainTab.offsetHeight - self.el.searcharea.offsetHeight - 60) + 'px';
