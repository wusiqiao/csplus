...
class ComWithdrawalsModel extends Model
{
    public function getSingleWithdrawalData($id,$options = [],$alias = 'a')
    {
    ...
    public function handlerSingleWithdrawalSave($id,$options = [])
    {
