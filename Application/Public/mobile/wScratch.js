...
;(function ($) {
  ...
  /*beight--0--*/
    ...
    var isAndroid4 = useragent.indexOf("android 4.2") > 0;
  ...
  $.fn.innerWidth = $.fn.width;
  $.fn.innerHeight = $.fn.height;
  /*end--0--*/
  ...
  ScratchPad.prototype = {
      ...
      if (this.options.fg) {
        if (this.options.fg.charAt(0) === '#') {
          ...
          $img[0].onload=function(){
            _this.ctx.drawImage($img[0], 0, 0, width, height);
            _this.$img.show();
          }
          /*beight--1--*/
    ...
    _scratchFunc: function (e, event) {
      ...
      o.pageX = Math.floor(e.pageX - this.canvasOffset.left);
      o.pageY = Math.floor(e.pageY - this.canvasOffset.top);
      
      this['_scratch' + event](o);
      
      if (this.options.realtime || event === 'Up') {
        if (this.options['scratch' + event]) {
          this.options['scratch' + event].apply(this, [o, this._scratchPercent()]);
        }
      }
    },
