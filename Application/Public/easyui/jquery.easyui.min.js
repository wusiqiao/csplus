...
cc._size(opts);
var _2a8=0;   //set left height 
var _2a9="auto";
var _2aa=cc.find(">div.panel>div.accordion-header");
if(_2aa.length){
_2a8=$(_2aa[0]).css("height","")._outerHeight()+10;
}
if(!isNaN(parseInt(opts.height))){
...
$("<span class='accordion-choosemark'></span>").appendTo(_2c8); //cxx 2015-03-17
...
_2c9.find(".accordion-choosemark").remove(); //cxx 2015-03-17
...
//var _54a=opts.selections[opts.highlight]; akunzeng
var _54a= [0,2];
...
_972(this,q);
    ...
    $(this).closest("div.combo-panel").panel("close");
    var opts = $(_990).datebox('options');
    opts.onSelect.call(_990, null);
}}],formatter:function(date){
...
var tt=[_999(date.getHours()),_999(date.getMinutes())]; //akunzeng 20190225
if (opts.zeroMinute){
    tt=[_999(date.getHours()),"00"]
}
if(opts.showSeconds){
